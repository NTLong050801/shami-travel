...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'travic' . '_options';
	...
	private $page_slug = 'travic' . '_options';
	...
	private $docs_link = 'https://docs.template_path.com';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'TRAVIC Options', 'travic' );
		$this->page_title = esc_html__( 'TRAVIC Options', 'travic' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'travic_options',
		...
		$args['share_icons'][] = array(
			'url'   => 'https://www.pinterest.com/template_path_/',
			'title' => 'Visit us on Pinterest',
			'icon'  => 'el el-pinterest',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.facebook.com/people/@/template_path',
			'title' => 'Like us on Facebook',
			'icon'  => 'el el-facebook',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://twitter.com/template_path',
			'title' => 'Follow us on Twitter',
			'icon'  => 'el el-twitter',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.linkedin.com/company/template_path-web-arcade',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'travic' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'travic' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'travic' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'travic' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'travic' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'travic_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "travic_redux_sections_{$key}", $options );
