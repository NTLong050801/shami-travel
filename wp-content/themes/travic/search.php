...
global $wp_query;
$data  = \TRAVIC\Includes\Classes\Common::instance()->data( 'search' )->get();
    ...
    <section class="page-title centred">
        ...
        <div class="auto-container">
            <div class="content-box">
                <h1><?php if ($data->get('title')) { echo wp_kses($data->get('title'), true); } else { echo esc_html('Search Results for: ') . esc_html($search_query); } ?></h1>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?> <?php if ( $data->get( 'layout' ) == 'left' ) echo 'pl-0'; elseif ( $data->get( 'layout' ) == 'right' ) echo ''; ?>">
                	<div class="blog-standard-content">
                        ...
                        <?php else : ?>
                        <div class="thm-sidebar-box blog-sidebar default-sidebar">
                            <p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'travic' ); ?></p>
                            <?php get_search_form() ?>
                        </div>
                        <?php endif; ?>
