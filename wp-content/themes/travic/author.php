...
global $wp_query;
$data  = \TRAVIC\Includes\Classes\Common::instance()->data( 'author' )->get();
    ...
    <section class="page-title centred">
        ...
        <div class="auto-container">
            <div class="content-box">
                <h1><?php if ($data->get('title')) { echo wp_kses($data->get('title'), true); } else { echo get_the_author_meta('display_name', $author_id); } ?> </h1>
