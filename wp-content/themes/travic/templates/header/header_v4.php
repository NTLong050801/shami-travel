    ...
    <div id="search-popup" class="search-popup">
        <div class="popup-inner">
            <div class="upper-box clearfix">
                <figure class="logo-box pull-left"><?php echo travic_logo( $logo_type, $main_logo, $main_logo_dimension, $logo_text, $logo_typography ); ?></figure>
            ...
            <div class="auto-container">
                <div class="outer-box">
                    ...
                    <div class="menu-right-content">
                        ...
                        <div class="btn-box"><a href="<?php echo esc_url($options->get('btn_link_v4')); ?>" class="theme-btn btn-one"><?php echo wp_kses($options->get('btn_title_v4'), true); ?></a></div>
                    </div>
                    <?php } ?>
                </div>
            </div>
