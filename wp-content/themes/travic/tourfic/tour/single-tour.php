...
while ( have_posts() ) : the_post();
	...
	if (class_exists("tourfic-vendor/tourfic-vendor.php")) {
	...
	if( $tf_tour_selected_template == "design-1" ){
		include get_template_directory() . '/tourfic/tour/single/design-1.php';
	}elseif( $tf_tour_selected_template == "design-2" ){
		include get_template_directory() . '/tourfic/tour/single/design-2.php';
	}else{
		include get_template_directory() . '/tourfic/tour/single/design-default.php';
	}
	?>
<?php
endwhile;
