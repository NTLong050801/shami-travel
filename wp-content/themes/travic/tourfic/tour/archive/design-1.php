<div class="tf-archive-page tf-template-global tf-archive-design-1 bg-gradient-to-t to-[#FFF1EC] from-white z-1 relative">
    <div class="container">
            ...
            <div class="tf-column tf-page-content tf-archive-left tf-result-previews">
                ...
                <div class="tf-archive-head tf-flex tf-flex-align-center tf-flex-space-bttn">
                    ...
                    <div class="tf-search-layout tf-flex tf-flex-gap-12">
                        <div class="tf-icon tf-serach-layout-list tf-list-active tf-grid-list-layout <?php echo esc_attr( $tf_defult_views=="list" ) ? esc_attr('active') : ''; ?>" data-id="list-view">
                        ...
                        <div class="tf-icon tf-serach-layout-grid tf-grid-list-layout <?php echo esc_attr( $tf_defult_views=="grid" ) ? esc_attr('active') : ''; ?>" data-id="grid-view">
                            <div class="defult-view">
                ...
                <div class="tf-search-results-list tf-mt-30">
                    <div class="archive_ajax_result tf-item-cards tf-flex <?php echo esc_attr( $tf_defult_views=="list" ) ? esc_attr('tf-layout-list') : esc_attr('tf-layout-grid'); ?> ">
					...
					if ( $loop->have_posts() ) {          
						...
						echo '<div class="tf-nothing-found" data-post-count="0" >' .esc_html__("No Tours Found!", "travic"). '</div>';
					}
					?>
