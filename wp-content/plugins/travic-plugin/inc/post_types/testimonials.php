...
namespace TRAVICPLUGIN\Inc\Post_Types;

use TRAVICPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  TRAVICPLUGIN/Abstracts
...
class Testimonials extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wptravic' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wptravic' );
