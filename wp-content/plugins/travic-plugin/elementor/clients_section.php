...
class Clients_Section extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Travic Clients Section', 'travic' );
    }
    /**
     * Get widget icon.
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'clients_section',
            [
                'label' => esc_html__( 'Clients Section', 'travic' ),
            ]
        );
	...
	?>
        ...
        <section class="clients-section pt_80 pb_80">
            <div class="auto-container te-banner">
                <div class="five-item-carousel owl-carousel owl-theme <?php if( $settings['arrows'] == 'yes' ) echo 'nav-style-one'; else echo 'owl-nav-none';?> <?php if( $settings['dots'] == 'yes' ) echo 'dots-style-one'; else echo 'owl-dots-none';?>"
                data-owl-options='{
                  ...
                  >
					...
					?>	
                        <figure class="clients-logo"><a href="<?php echo esc_url( $mount_link );?>" <?php if( $page == 'extranal' ) echo esc_attr( $target );?> <?php if( $page == 'extranal' ) echo esc_attr( $nofollow );?> ><img src="<?php echo esc_url(wp_get_attachment_url($item['feature_image']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'travic'); ?>"></a></figure>
                    <?php } ?>
					<?php endforeach; ?>
